...
config :skill_sanity, SkillSanityWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Bl1hmux+YSpy9G8Qj3PAcgjMprg2FUS1OwyuWSevD9347aT8rsVG8aJvEbyWxyai",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:skill_sanity, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:skill_sanity, ~w(--watch)]}
  ]
...
config :skill_sanity, SkillSanityWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/skill_sanity_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
